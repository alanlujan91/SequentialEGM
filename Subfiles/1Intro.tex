...
However, the engodenous grid method is limited to a few specific classes of problems. Recently, the classes of problems to which EGM can be applied has been expanded\footnote{\cite{Barillas2007-uh, Maliar2013-sv, Fella2014-my, White2015-fg, Iskhakov2017-my}, among others.}, but with every new method comes a new set of limitations.
