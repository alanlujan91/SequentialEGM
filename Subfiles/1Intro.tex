...
The first section below presents a basic model that illustrates the sequential endogenous grid method in 1 dimension. Then section 2 introduces a more complex method with 2 state variables to demonstrate the use of machine learning tools to generate an interpolating function. In section 3 I present the unstructured interpolation methods using machine learning in more detail. Section 4 discusses the theoretical requirements to use the Sequential Endogenous Grid Method. Finally, section 5 concludes with some limitations and future work.
