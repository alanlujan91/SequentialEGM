...
\ifthenelse{\boolean{Web}}{
  ...
  \begin{minipage}{0.9\textwidth}
    \footnotesize I would like to thank Christopher D. Carroll and Simon Scheidegger for their helpful comments and suggestions. Remaining errors are my own. All figures and other numerical results were produced using the \href{https://econ-ark/HARK}{\texttt{Econ-ARK/HARK}} toolkit (\cite{Carroll2018-om}). Additional libraries used in the production of this paper include but are not limited to: \href{https://www.scipy.org/}{\texttt{scipy}} (\cite{Virtanen2020-qo}), \href{https://www.numpy.org/}{\texttt{numpy}} (\cite{Harris2020-sm}), \href{https://numba.pydata.org/}{\texttt{numba}} (\cite{Lam2015-vo}), \href{https://cupy.dev/}{\texttt{cupy}} (\cite{Okuta2017-gd}), \href{https://scikit-learn.org/}{\texttt{scikit-learn}} (\cite{Pedregosa2011-zs}), \href{https://pytorch.org/}{\texttt{pytorch}} (\cite{Paszke2019-xe}), and \href{https://gpytorch.ai/}{\texttt{gpytorch}} (\cite{Gardner2018-mv}).
  \end{minipage}
} % {Web}
