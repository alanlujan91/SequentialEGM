...
\newcommand{\cE}{\cRat^{e}}
\newcommand{\xRat}{x}
\newcommand{\aMat}{[{\mathrm{\aNrm}}]}
\newcommand{\mEndFunc}{\mathfrak{m}}
\newcommand{\mE}{\mRat^{e}}
\newcommand{\mMat}{[{\mathrm{\mNrm}}]}
...
\subsection{The Sequential Endogenous Grid Method}\label{sec:method}
...
\subsubsection{Restating the problem sequentially}\label{Restating the problem sequentially}
...
\subsubsection{The portfolio decision subproblem}\label{The portfolio decision subproblem}
...
\paragraph{A note on avoiding taking expectations more than once.}\label{A note on avoiding taking expectations more than once.}
...
\subsubsection{The consumption-saving subproblem}\label{The consumption-saving subproblem}
...
\subsubsection{The labor-leisure subproblem}\label{The labor-leisure subproblem}
...
\subsubsection{Curvilinear Grids}\label{Curvilinear Grids}
