...
date: "Computing in Economics and Finance, July 2023 <br> Université Côte d'Azur - Nice, France"
output:
...
Constraint is handled by exogenous grid. $\aMat > \underline{\aRat}$.
...
![](figures/Warpednterpolation.svg)
...
- Via Taste Shocks where the choice specific problem for a working household that decides to
continue working is
...
- If $\sigma$ is sufficiently large, value and marginal value functions are continuous and differentiable
...
[`github.com/econ-ark/HARK`](https://github.com/econ-ark/HARK)

[`github.com/alanlujan91/SequentialEGM`](https://github.com/alanlujan91/SequentialEGM)