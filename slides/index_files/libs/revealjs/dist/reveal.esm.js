  ...
  f = (p.default = (function (e) {
    if (e) {
      var t = function (e) {
        ...
        S = function (e) {
          e.observeMutations &&
            ((e.observer = new MutationObserver(y(e, s))),
      ...
      Array.from(t).forEach((t, s) => {
        if (
          (t.hasAttribute("data-fragment-index") &&
            (s = parseInt(t.getAttribute("data-fragment-index"), 10)),
          (a = Math.max(a, s)),
          s <= e)
        ) {
    ...
    i.forEach(function (i, a) {
      if (!1 === i.classList.contains("stack")) {
        ...
        (p = Math.min(p, e.pdfMaxPagesPerSlide)),
          ((1 === p && e.center) || i.classList.contains("center")) &&
            (c = Math.max((r - v) / 2, 0));
        ...
        if (
          ...
          i.slideBackgroundElement &&
            m.insertBefore(i.slideBackgroundElement, i),
          e.showNotes)
        ) {
...
function U(n, l) {
  ...
  function Ee() {
    w.postMessage && window.addEventListener("message", Dt, !1);
  }
  function Re(t) {
    const s = { ...w };
    if (("object" == typeof t && e(w, t), !1 === h.isReady())) return;
    const a = K.wrapper.querySelectorAll(".slides section").length;
    K.wrapper.classList.remove(s.transition),
  ...
  function Se() {
    window.addEventListener("resize", Ft, !1),
      ...
      se.bind(),
      le.bind(),
      K.slides.addEventListener("click", Tt, !1),
      K.slides.addEventListener("transitionend", It, !1),
      K.pauseOverlay.addEventListener("click", Xe, !1),
      w.focusBodyOnPageVisibilityChange &&
        document.addEventListener("visibilitychange", zt, !1);
  }
  function Ae() {
    de.unbind(),
      le.unbind(),
      ...
      K.slides.removeEventListener("click", Tt, !1),
      K.slides.removeEventListener("transitionend", It, !1),
  ...
  function ke() {
    Ae(),
      ...
      document.removeEventListener("visibilitychange", zt, !1),
      window.removeEventListener("message", Dt, !1),
  ...
  function xe(e) {
    "string" == typeof e.layout && (W.layout = e.layout),
      ...
      W.layout
        ? a(K.slides, W.layout + " " + W.overview)
        : a(K.slides, W.overview);
  }
  function Pe({ target: t = K.wrapper, type: i, data: s, bubbles: a = !0 }) {
  ...
  function Ne(t, i) {
    if (w.postMessageEvents && window.parent !== window.self) {
      let s = { namespace: "reveal", eventName: t, state: yt() };
  ...
  function Me(e = "a") {
    Array.from(K.wrapper.querySelectorAll(e)).forEach((e) => {
      /^(http|www)/gi.test(e.getAttribute("href")) &&
        e.addEventListener("click", qt, !1);
    });
  }
  function De(e = "a") {
    Array.from(K.wrapper.querySelectorAll(e)).forEach((e) => {
      /^(http|www)/gi.test(e.getAttribute("href")) &&
        e.removeEventListener("click", qt, !1);
    });
  }
  function Ie(e) {
    ze(),
      ...
      if (!w.disableLayout) {
        ...
        for (let t = 0, s = i.length; t < s; t++) {
          ...
          "none" !== s.style.display &&
            (w.center || s.classList.contains("center")
              ? s.classList.contains("stack")
                ? (s.style.top = 0)
                : (s.style.top =
                    Math.max((e.height - s.scrollHeight) / 2, 0) + "px")
              : (s.style.top = ""));
        }
        t !== U &&
  ...
  function Xe() {
    const e = K.wrapper.classList.contains("paused");
    K.wrapper.classList.remove("paused"), Et(), e && Pe({ type: "resumed" });
  }
  function Ye(e) {
  ...
  function Je(e) {
    "boolean" == typeof e ? (e ? At() : St()) : Y ? At() : St();
  }
  function Qe() {
    return !(!$ || Y);
  }
  function Ze(e, t, i, s) {
    if (
      ...
      return;
    p = m;
    const a = K.wrapper.querySelectorAll(".slides>section");
    if (0 === a.length) return;
    void 0 !== t || ee.isActive() || (t = Ue(a[e])),
      p &&
        p.parentNode &&
    ...
    let r = u || 0,
      o = v || 0;
    (u = st(".slides>section", void 0 === e ? u : e)),
      (v = st(".slides>section.present>section", void 0 === t ? v : t));
    let l = u !== r || v !== o;
    l || (p = null);
    let d = a[u],
  ...
  function et(e = m) {
    Z.sync(e), G.sync(e), _.load(e), Z.update(), ce.update();
  }
  function tt() {
    ct().forEach((e) => {
      t(e, "section").forEach((e, t) => {
  ...
  function st(e, i) {
    ...
    if (a) {
      ...
      e.classList.add("present"),
        e.removeAttribute("hidden"),
        e.removeAttribute("aria-hidden"),
        r || Pe({ target: e, type: "visible", bubbles: !1 });
      let o = e.getAttribute("data-state");
      o && (I = I.concat(o.split(" ")));
    } else i = 0;
    return i;
  }
  function at() {
    ...
    if (a && void 0 !== u) {
      ...
      for (let r = 0; r < a; r++) {
        ...
        if (
          ...
          for (let s = 0; s < d; s++) {
            let a = l[s];
            (i = r === (u || 0) ? Math.abs((v || 0) - s) : Math.abs(s - t)),
              e + i < n ? _.load(a) : _.unload(a);
          }
        }
      }
      vt()
  ...
  function bt(e, t) {
    let i = "number" == typeof e ? ft(e, t) : e;
  ...
  function wt(e) {
    if ("object" == typeof e) {
      Ze(s(e.indexh), s(e.indexv), s(e.indexf));
      let t = s(e.paused),
        i = s(e.overview);
    ...
    if ((Rt(), m && !1 !== w.autoSlide)) {
      ...
      i
        ...
        !$ ||
          ...
          _e() ||
          ee.isActive() ||
          ($e() && !G.availableRoutes().next && !0 !== w.loop) ||
          ((j = setTimeout(() => {
            "function" == typeof w.autoSlideMethod ? w.autoSlideMethod() : Nt(),
              Et();
          }, $)),
          (X = Date.now())),
        f && f.setPlaying(-1 !== j);
  ...
  function At() {
    $ && Y && ((Y = !1), Pe({ type: "autoslideresumed" }), Et());
  }
  function kt({ skipFragments: e = !1 } = {}) {
    (A.hasNavigatedHorizontally = !0),
      w.rtl
        ? (ee.isActive() || e || !1 === G.next()) &&
          nt().left &&
          Ze(u + 1, "grid" === w.navigationMode ? v : void 0)
        : (ee.isActive() || e || !1 === G.prev()) &&
          nt().left &&
          Ze(u - 1, "grid" === w.navigationMode ? v : void 0);
  }
  ...
  function Ct({ skipFragments: e = !1 } = {}) {
    (ee.isActive() || e || !1 === G.prev()) && nt().up && Ze(u, v - 1);
  }
  function xt({ skipFragments: e = !1 } = {}) {
    (A.hasNavigatedVertically = !0),
      (ee.isActive() || e || !1 === G.next()) && nt().down && Ze(u, v + 1);
  }
  function Pt({ skipFragments: e = !1 } = {}) {
    if (e || !1 === G.prev())
      if (nt().up) Ct({ skipFragments: e });
      else {
        let i;
        if (
          ((i = w.rtl
  ...
  const Ot = {
    ...
    navigatePrev: Pt,
    navigateNext: Nt,
    navigateFragment: G.goto.bind(G),
    prevFragment: G.prev.bind(G),
    nextFragment: G.next.bind(G),
    on: Le,
    off: Ce,
    addEventListener: Le,
    ...
    shuffle: it,
    availableRoutes: nt,
    availableFragments: G.availableRoutes.bind(G),
    toggleHelp: Te,
    ...
    getSlides: dt,
    getHorizontalSlides: ct,
    getVerticalSlides: ht,
    hasHorizontalSlides: gt,
    ...
    getBackgroundsElement: () => Z.element,
