...
lottery_size = lottery_size_NOK / (
    270 / 4
)  # Håkon estimated yearly permanent income to be 270k, i.e. 270/4 on a quarterly basis
...
def z_function(x, y, fixed_splurge):
    [
        ...
        Lorenz_Data_Adj,
        Wealth_Perm_Ratio,
    ] = FagerengObjFunc(fixed_splurge, x, y, estimation_mode=False, target="AGG_MPC")
