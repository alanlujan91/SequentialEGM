...
if Run_Main:
    ...
    Output_Results(
        Abs_Path + "/Figures/CRRA2/",
        Abs_Path + "/Figures/",
        Abs_Path + "/Tables/CRRA2/",
...
if Run_EqualPVs:
    ...
    Output_Results(
        Abs_Path + "/Figures/CRRA2_PVSame/",
        Abs_Path + "/Figures/CRRA2_PVSame/",
        Abs_Path + "/Tables/CRRA2_PVSame/",
        Parametrization="CRRA2_PVSame",
    )
...
if Run_ADElas_robustness:
    ...
    Output_Results(
        Abs_Path + "/Figures/ADElas/",
        Abs_Path + "/Figures/ADElas/",
        Abs_Path + "/Tables/ADElas/",
        Parametrization="ADElas",
    )

    figs_dir = Abs_Path + "/Figures/ADElas_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="ADElas_PVSame")
    Output_Results(
        Abs_Path + "/Figures/ADElas_PVSame/",
        Abs_Path + "/Figures/ADElas_PVSame/",
        Abs_Path + "/Tables/ADElas_PVSame/",
        Parametrization="ADElas_PVSame",
    )
...
if Run_CRRA1_robustness:
    ...
    Output_Results(
        Abs_Path + "/Figures/CRRA1/",
        Abs_Path + "/Figures/CRRA1/",
        Abs_Path + "/Tables/CRRA1/",
        Parametrization="CRRA1",
    )

    figs_dir = Abs_Path + "/Figures/CRRA1_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="CRRA1_PVSame")
    Output_Results(
        Abs_Path + "/Figures/CRRA1_PVSame/",
        Abs_Path + "/Figures/CRRA1_PVSame/",
        Abs_Path + "/Tables/CRRA1_PVSame/",
        Parametrization="CRRA1_PVSame",
    )
...
if Run_CRRA3_robustness:
    ...
    Output_Results(
        Abs_Path + "/Figures/CRRA3/",
        Abs_Path + "/Figures/CRRA3/",
        Abs_Path + "/Tables/CRRA3/",
        Parametrization="CRRA3",
    )

    figs_dir = Abs_Path + "/Figures/CRRA3_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="CRRA3_PVSame")
    Output_Results(
        Abs_Path + "/Figures/CRRA3_PVSame/",
        Abs_Path + "/Figures/CRRA3_PVSame/",
        Abs_Path + "/Tables/CRRA3_PVSame/",
        Parametrization="CRRA3_PVSame",
    )
...
if Run_Rfree_robustness:
    ...
    Output_Results(
        Abs_Path + "/Figures/Rfree_1005/",
        Abs_Path + "/Figures/Rfree_1005/",
        Abs_Path + "/Tables/Rfree_1005/",
        Parametrization="Rfree_1005",
    )

    figs_dir = Abs_Path + "/Figures/Rfree_1005_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="Rfree_1005_PVSame")
    Output_Results(
        Abs_Path + "/Figures/Rfree_1005_PVSame/",
        Abs_Path + "/Figures/Rfree_1005_PVsame/",
        Abs_Path + "/Tables/Rfree_1005_PVsame/",
        Parametrization="Rfree_1005_PVSame",
    )

    figs_dir = Abs_Path + "/Figures/Rfree_1015/"
    Simulate(Run_Dict, figs_dir, Parametrization="Rfree_1015")
    Output_Results(
        Abs_Path + "/Figures/Rfree_1015/",
        Abs_Path + "/Figures/Rfree_1015/",
        Abs_Path + "/Tables/Rfree_1015/",
        Parametrization="Rfree_1015",
    )

    figs_dir = Abs_Path + "/Figures/Rfree_1015_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="Rfree_1015_PVSame")
    Output_Results(
        Abs_Path + "/Figures/Rfree_1015_PVSame/",
        Abs_Path + "/Figures/Rfree_1015_PVSame/",
        Abs_Path + "/Tables/Rfree_1015_PVSame/",
        Parametrization="Rfree_1015_PVSame",
    )
...
if Run_Rspell_robustness:
    ...
    Output_Results(
        Abs_Path + "/Figures/Rspell_4/",
        Abs_Path + "/Figures/Rspell_4/",
        Abs_Path + "/Tables/Rspell_4/",
        Parametrization="Rspell_4",
    )

    figs_dir = Abs_Path + "/Figures/Rspell_4_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="Rspell_4_PVSame")
    Output_Results(
        Abs_Path + "/Figures/Rspell_4_PVSame/",
        Abs_Path + "/Figures/Rspell_4_PVSame/",
        Abs_Path + "/Tables/Rspell_4_PVSame/",
        Parametrization="Rspell_4_PVSame",
    )
...
if Run_LowerUBnoB:
    ...
    Output_Results(
        Abs_Path + "/Figures/LowerUBnoB/",
        Abs_Path + "/Figures/LowerUBnoB/",
        Abs_Path + "/Tables/LowerUBnoB/",
        Parametrization="LowerUBnoB",
    )

    figs_dir = Abs_Path + "/Figures/LowerUBnoB_PVSame/"
    Simulate(Run_Dict, figs_dir, Parametrization="LowerUBnoB_PVSame")
    Output_Results(
        Abs_Path + "/Figures/LowerUBnoB_PVSame/",
        Abs_Path + "/Figures/LowerUBnoB_PVSame/",
        Abs_Path + "/Tables/LowerUBnoB_PVSame/",
        Parametrization="LowerUBnoB_PVSame",
    )
