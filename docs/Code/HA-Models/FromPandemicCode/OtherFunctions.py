...
def getSimulationDiff(simulation_base, simulation_alternative, simulation_variable):
    return (
        simulation_alternative[simulation_variable]
        - simulation_base[simulation_variable]
    )


def getSimulationPercentDiff(
    simulation_base, simulation_alternative, simulation_variable
):
    SimDiff = getSimulationDiff(
        simulation_base, simulation_alternative, simulation_variable
    )
