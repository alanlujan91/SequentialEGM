...
if len(sys.argv) < 2:
    ...
    resFile = open(res_dir + "/AllResults_CRRA_2.0_R_1.01.txt")
    model_LorenzPts = []
    ...
    if int(sys.argv[1]) == 1:
        ...
        resFile1 = open(res_dir + "/AllResults_CRRA_2.0_R_1.005.txt")
        resFile2 = open(res_dir + "/AllResults_CRRA_2.0_R_1.015.txt")
        mylabels = ["R = 0.5 %", "R = 1.5 %"]
        myFigFile = "LorenzPoints_robustness_R"
    elif int(sys.argv[1]) == 2:
        # Load series for robustness figure w.r.t. risk aversion CRRA
        resFile1 = open(res_dir + "/AllResults_CRRA_1.0_R_1.01.txt")
        resFile2 = open(res_dir + "/AllResults_CRRA_3.0_R_1.01.txt")
