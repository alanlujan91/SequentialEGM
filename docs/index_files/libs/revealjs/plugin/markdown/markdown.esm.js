  ...
  return [
    ...
    function (e) {
      ...
      for (var a, s = [], l = 0; null !== (a = Au(u, i)); ) {
        var c = String(a[0]);
        ((s[l] = c),
          "" === c && (u.lastIndex = yu(i, du(u.lastIndex), o)),
          l++);
      }
      return 0 === l ? null : s;
    },
...
Xn("search", 1, function (e, t, n) {
  return [
    ...
    function (e) {
      ...
      var a = Kc(u, i);
      return (
        Yc(u.lastIndex, o) || (u.lastIndex = o),
        null === a ? -1 : a.index
      );
    },
  ];
...
function Wf(e, t, n) {
  ...
  if (
    ...
    var i = function (e) {
      ...
      if (!e)
        try {
          (t.walkTokens && Wf.walkTokens(r, t.walkTokens),
            (i = Xf.parse(r, t)));
        } catch (t) {
          e = t;
        }
...
((Wf.options = Wf.setOptions =
  ...
  (Wf.parseInline = function (e, t) {
    ...
    try {
      ...
      return (
        t.walkTokens && Wf.walkTokens(n, t.walkTokens),
        Xf.parseInline(n, t)
      );
    } catch (e) {
      if (
