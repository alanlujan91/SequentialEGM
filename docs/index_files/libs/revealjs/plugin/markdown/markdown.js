        ...
        : $o && !To
          ...
          : Co.addEventListener &&
            ...
            : (mo =
                No in _o("script")
                  ? function (e) {
                      So.appendChild(_o("script")).onreadystatechange =
                        function () {
    ...
    { target: "Array", proto: !0, forced: !Jc },
    {
      splice: function (e, t) {
        ...
        if (((u.length = r), n < r)) {
          ...
          for (i = l - r; i > c; i--)
            ((a = i + n - 1),
              (o = i + r - 1) in s ? (s[a] = s[o]) : delete s[a]);
  ...
  Jn("search", 1, function (e, t, n) {
    return [
      ...
      function (e) {
        ...
        var a = Df(u, i);
        return (
          hf(u.lastIndex, o) || (u.lastIndex = o),
          null === a ? -1 : a.index
        );
      },
    ];
              ...
              if (t) {
                ...
                if (n.header.length === n.align.length) {
                  ...
                  for (a = n.rows.length, r = 0; r < a; r++)
                    n.rows[r] = ep(n.rows[r], n.header.length).map(
                      function (e) {
                        return { text: e };
                      },
                    );
  ...
  ((gp.options = gp.setOptions =
          ...
          switch ((t.call(gp, e), e.type)) {
            ...
            default:
              ...
              gp.defaults.extensions.childTokens[e.type]
                ? gp.defaults.extensions.childTokens[e.type].forEach(
                    function (n) {
                      gp.walkTokens(e[n], t);
                    },
                  )
    ...
    (gp.parseInline = function (e, t) {
      ...
      try {
        ...
        return (
          t.walkTokens && gp.walkTokens(n, t.walkTokens),
          Dp.parseInline(n, t)
        );
      } catch (e) {
        if (
