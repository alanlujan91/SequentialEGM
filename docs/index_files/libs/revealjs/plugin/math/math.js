!(function (t, e) {
  ...
  (Z.exports = function (t, e, n, r) {
    ...
    "function" == typeof n &&
      ...
      (o = Ut(n)).source ||
        (o.source = Kt.join("string" == typeof e ? e : ""))),
      t !== $t
  ...
  var xe = Vt,
    ...
    on =
      ...
      Ye(function () {
        ...
        ? function (t, e) {
            for (
              var n = tn(t), r = arguments.length, o = 1, i = Ve.f, a = Ze.f;
              r > o;
  ...
  wn
    ...
    : gn &&
      (!(dn = gn.match(/Edge\/(\d+)/)) || dn[1] >= 74) &&
      (dn = gn.match(/Chrome\/(\d+)/)) &&
      (vn = dn[1]);
  var jn = vn && +vn,
    xn = jn,
    On = o,
  ...
  (Ur && Kr) ||
    ...
    Wr
      ...
      : Yr && Yr.now
        ...
        : Xr && !zr
          ? ((_r = (Lr = new Xr()).port2),
            (Lr.port1.onmessage = no),
            (kr = $r(_r.postMessage, _r, 1)))
          : Jr.addEventListener &&
            ...
            : (kr =
                Zr in Hr("script")
                  ? function (t) {
                      Gr.appendChild(Hr("script")).onreadystatechange =
                        function () {
  ...
  var _o,
    ...
    Ko = function (t, e, n) {
      t &&
        !er((t = n ? t : t.prototype), nr) &&
        tr(t, nr, { configurable: !0, value: e });
    },
    Qo = function (t) {
      var e = rr(t),
        n = or.f;
    ...
    Zo = function (t, e, n) {
      ...
      if (p) r = t;
        ...
        if ("function" != typeof (o = xr(t)))
          throw TypeError("Target is not iterable");
        if (br(o)) {
          for (i = 0, a = wr(t.length); a > i; i++)
            if ((c = y(t[i])) && c instanceof Er) return c;
          return new Er(!1);
        }
        r = o.call(t);
      }
    ...
    Li = fi(di, function () {
      ...
      return (
        ((e.constructor = {})[hi] = n),
        !(ki = e.then(function () {}) instanceof n) || (!t && si && !Pi)
      );
    }),
    _i =
      Li ||
    ...
    Ri = function (t, e, n) {
      ...
      Ti
        ...
        !Pi && (o = Go["on" + t])
          ? o(r)
          : t === Mi && ii("Unhandled promise rejection", n);
    },
    Ci = function (t) {
      ni.call(Go, function () {
        var e,
    ...
    Fi = function (t) {
      ni.call(Go, function () {
        var e = t.facade;
        li
          ? Oi.emit("rejectionHandled", e)
          : Ri("rejectionhandled", e, t.value);
      });
    },
    Ji = function (t, e, n) {
      return function (r) {
    ...
    Di = function (t, e, n) {
      t.done ||
        ((t.done = !0), n && (t = n), (t.value = e), (t.state = 2), Ii(t, !0));
    },
    $i = function (t, e, n) {
      if (!t.done) {
        (t.done = !0), n && (t = n);
  ...
  var Gi,
    ...
    qi = i
      ...
      : function (t, e) {
          zi(t);
          for (var n, r = Wi(e), o = r.length, i = 0; o > i; )
            Hi.f(t, (n = r[i++]), e[n]);
          return t;
        },
    Ui = W,
