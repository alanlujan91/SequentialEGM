  ...
  Un("search", 1, function (t, e, n) {
    return [
      ...
      function (t) {
        ...
        var o = Qn(i, u);
        return (
          Kn(i.lastIndex, a) || (i.lastIndex = a),
          null === o ? -1 : o.index
        );
      },
    ];
    ...
    { target: "Array", proto: !0, forced: !mu },
    {
      splice: function (t, e) {
        ...
        if (((i.length = r), n < r)) {
          ...
          for (u = l - r; u > c; u--)
            ((o = u + n - 1),
              (a = u + r - 1) in s ? (s[o] = s[a]) : delete s[o]);
                      ...
                      this.options.extensions &&
                        ...
                        (function () {
                          var e = 1 / 0,
                            n = t.slice(1),
                            i = void 0;
                          (u.options.extensions.startBlock.forEach(
                            function (t) {
                              "number" ==
  ...
  ((ds.options = ds.setOptions =
    ...
    (ds.parseInline = function (t, e) {
      ...
      try {
        ...
        return (
          e.walkTokens && ds.walkTokens(n, e.walkTokens),
          ps.parseInline(n, e)
        );
      } catch (t) {
        if (
