...
(X.exports = function (t, e, n, r) {
  ...
  "function" == typeof n &&
    ...
    t !== Pt
      ? (u ? !o && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : Mt(t, e, n))
      : a
        ? (t[e] = n)
        : Nt(e, n);
  ...
  ce = function (t) {
    return function (e, n, r) {
      ...
      if (t && n != n) {
        ...
        for (; a > o; o++) if ((t || o in u) && u[o] === n) return t || o || 0;
      return !t && -1;
    };
  },
...
var Qe = We,
  ...
  nn = (function () {
    var t = /a/,
      e = /b*/g;
    return (
      Xe.call(t, "a"), Xe.call(e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex
    );
  })(),
...
dn
  ...
  : ln &&
    (!(on = ln.match(/Edge\/(\d+)/)) || on[1] >= 74) &&
    (on = ln.match(/Chrome\/(\d+)/)) &&
    (sn = on[1]);
var fn = sn && +sn,
  hn = fn,
  gn = i,
  ...
  return (
    ...
    (function (t, e) {
      ...
      try {
        for (
          n = n.call(t);
          !(a = (r = n.next()).done) && (u.push(r.value), !e || u.length !== e);
          a = !0
        );
      } catch (t) {
        (o = !0), (i = t);
...
if (
  ...
  qr(
    ...
    !ui ||
      ...
      Gr(function () {
        return (
          (ii[ti] = !1), ei(ri) != ri || ei(ii) == ii || "/a/i" != ei(ri, "i")
        );
      }),
  )
) {
  for (
    var oi = function (t, e) {
        ...
        ui
          ? i && !u && (t = t.source)
          : t instanceof oi && (u && (e = Vr.call(t)), (t = t.source)),
  ...
  pi(
    ...
    function () {
      ...
      return (
        ...
        "/" +
        String(
          void 0 === n && t instanceof RegExp && !("flags" in gi)
            ? hi.call(t)
            : n,
        )
      );
      ...
      [
        ...
        function (t, i) {
          ...
          for (var f = 0, h = 0, g = []; h < o.length; ) {
            ...
            if (
              null === m ||
              (D = Ii(Bi(p.lastIndex + (zi ? h : 0)), o.length)) === f
            )
              h = Si(o, h, l);
            else {
...
var Li = D,
  ...
  Mi = function (t) {
    return function (e) {
      var n = String(Li(e));
      return (
        1 & t && (n = n.replace($i, "")), 2 & t && (n = n.replace(Pi, "")), n
      );
    };
  },
...
var Fa,
  ...
  _a = u
    ...
    : function (t, e) {
        Ba(t);
        for (var n, r = Ta(e), i = r.length, u = 0; i > u; )
          Sa.f(t, (n = r[u++]), e[n]);
        return t;
      },
    ...
    concat: function (t) {
      ...
      for (e = -1, r = arguments.length; e < r; e++)
        if (fo((u = -1 === e ? a : arguments[e]))) {
          if (s + (i = io(u.length)) > 9007199254740991)
...
function _o(t, e) {
  ...
  var n = {
    replace: function (e, r) {
      return (
        (r = (r = r.source || r).replace(To, "$1")), (t = t.replace(e, r)), n
      );
    },
    getRegex: function () {
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if ((n = this.rules.inline.url.exec(t))) {
              var r, i;
              if ("@" === n[2])
                i = "mailto:" + (r = Fo(this.options.mangle ? e(n[0]) : n[0]));
              else {
                var u;
                do {
                  (u = n[0]),
...
(Jo.def = _o(Jo.def)
  .replace("label", Jo._label)
  .replace("title", Jo._title)
  .getRegex()),
  (Jo.bullet = /(?:[*+-]|\d{1,9}[.)])/),
  ...
  (Jo.paragraph = _o(Jo._paragraph)
    ...
    .replace("tag", Jo._tag)
    .getRegex()),
  (Jo.blockquote = _o(Jo.blockquote)
    .replace("paragraph", Jo.paragraph)
    .getRegex()),
  (Jo.normal = jo({}, Jo)),
  (Jo.gfm = jo({}, Jo.normal, {
    table:
...
(Vo._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
  ...
  (Vo.emStrong.lDelim = _o(Vo.emStrong.lDelim)
    .replace(/punct/g, Vo._punctuation)
    .getRegex()),
  (Vo.emStrong.rDelimAst = _o(Vo.emStrong.rDelimAst, "g")
    .replace(/punct/g, Vo._punctuation)
    .getRegex()),
  (Vo.emStrong.rDelimUnd = _o(Vo.emStrong.rDelimUnd, "g")
    .replace(/punct/g, Vo._punctuation)
    .getRegex()),
  (Vo._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
  ...
  (Vo.autolink = _o(Vo.autolink)
    .replace("scheme", Vo._scheme)
    .replace("email", Vo._email)
    .getRegex()),
  (Vo._attribute =
    /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
  (Vo.tag = _o(Vo.tag)
    .replace("comment", Vo._comment)
    .replace("attribute", Vo._attribute)
    .getRegex()),
  (Vo._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
  (Vo._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
  (Vo._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
  (Vo.link = _o(Vo.link)
    ...
    .getRegex()),
  (Vo.reflink = _o(Vo.reflink)
    .replace("label", Vo._label)
    .replace("ref", Jo._label)
    .getRegex()),
  ...
  (Vo.gfm.url = _o(Vo.gfm.url, "i")
    .replace("email", Vo.gfm._extended_email)
    .getRegex()),
  (Vo.breaks = jo({}, Vo.gfm, {
...
var Go = (function () {
    function t(e) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm &&
          ((n.block = Jo.gfm),
          this.options.breaks ? (n.inline = Vo.breaks) : (n.inline = Vo.gfm)),
    ...
    return (
      or(t, [
        ...
        },
        {
          ...
          value: function (t, e, n) {
            if (
              null === (t = Io(this.options.sanitize, this.options.baseUrl, t))
            )
              return n;
            var r = '<a href="' + Fo(t) + '"';
...
function ns(t, e, n) {
  ...
  try {
    ...
    if (
      ...
      return (
        "<p>An error occurred:</p><pre>" + Fo(t.message + "", !0) + "</pre>"
      );
    throw t;
  }
}
(ns.options = ns.setOptions =
        ...
        switch ((e.call(ns, t), t.type)) {
          ...
          default:
            ...
            ns.defaults.extensions.childTokens[t.type]
              ? ns.defaults.extensions.childTokens[t.type].forEach(
                  function (n) {
                    ns.walkTokens(t[n], e);
                  },
                )
  ...
  (ns.parseInline = function (t, e) {
    ...
    try {
      ...
      return (
        e.walkTokens && ns.walkTokens(n, e.walkTokens), es.parseInline(n, e)
      );
    } catch (t) {
      if (
        ((t.message +=
