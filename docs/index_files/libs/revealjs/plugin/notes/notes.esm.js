...
jn("search", 1, function (t, e, n) {
  return [
    ...
    function (t) {
      ...
      var o = Vn(i, u);
      return (
        Jn(i.lastIndex, a) || (i.lastIndex = a),
        null === o ? -1 : o.index
      );
    },
  ];
  ...
  return [
    ...
    function (t) {
      ...
      for (var o, s = [], l = 0; null !== (o = ir(i, u)); ) {
        var c = String(o[0]);
        ((s[l] = c),
          "" === c && (i.lastIndex = rr(u, er(i.lastIndex), a)),
          l++);
      }
      return 0 === l ? null : s;
    },
...
function ns(t, e, n) {
  ...
  if (
    ...
    var u = function (t) {
      ...
      if (!t)
        try {
          (e.walkTokens && ns.walkTokens(r, e.walkTokens),
            (u = es.parse(r, e)));
        } catch (e) {
          t = e;
        }
...
((ns.options = ns.setOptions =
  ...
  (ns.parseInline = function (t, e) {
    ...
    try {
      ...
      return (
        e.walkTokens && ns.walkTokens(n, e.walkTokens),
        es.parseInline(n, e)
      );
    } catch (t) {
      if (
